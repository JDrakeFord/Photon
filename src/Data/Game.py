...
class LaserTagPlayerActionScreen(tk.Frame):
    ...
    def create_widgets(self):
        ...
        self.team1_label = tk.Label(self, text=self.team1_name, font=('Helvetica', 18))
        self.team1_label.grid(row=0, column=0, padx=10, pady=10)

        self.team2_label = tk.Label(self, text=self.team2_name, font=('Helvetica', 18))
        ...
        for i in range(20):
            player_label = tk.Label(self, text=self.team1_players[i], font=('Helvetica', 12))
            player_label.grid(row=4+i, column=0, padx=5, pady=1)

        self.team2_player_labels = []
        for i in range(20):
            player_label = tk.Label(self, text=self.team2_players[i], font=('Helvetica', 12))
